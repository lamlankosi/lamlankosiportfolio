<template>
    <div class="contact">
      <h1 class="title fade-in">Contact Me</h1>
      <div class="container fade-in" style="animation-delay: 0.3s">
        <div class="details">
          ...
          <p><i class="bi bi-linkedin"></i> <a href="www.linkedin.com/in/lamlankosi-nomnganga-59b500268" target="_blank">Lamla Nomnganga</a></p>
